<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
  <% String m_id = (String)session.getAttribute("m_id"); //유저id( DB)
    m_id = "root"; %>
...
<div id="total">
	...
	<font color="#7D5A38" size="5">리뷰 수정</font>
	<form action="rupdate.jsp"> 
	   <!-- ID: <input name="m_id" value=" <%= session.getAttribute("m_id") %>"><br> -->
		등록한 글번호: <input name="writern" value=" <%=request.getParameter("writern") %>"><br>
		수정할 날짜: <input name="today"><br> 이용한 호텔: <input
			name="h_name" value="<%=request.getParameter("h_name") %>"><br>
			
		<!-- 글번호: <input name="writern"><br> -->
		서비스점수:
...
<input type="radio" value="5" name="grade">5<br>
	...
	<a href="Reviewmain.jsp"><button>리뷰목록</button></a>
</body>
</html>